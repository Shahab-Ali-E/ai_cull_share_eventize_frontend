...
import CullingGetStartedButton from "./CullingGetStartedButton";
import { cn } from "@/lib/utils";

function CullingHeroSection() {
  return (
    <section className="relative flex flex-col-reverse md:flex-row w-full h-screen pt-0 md:pt-20 px-10 rounded-b-[30px] overflow-hidden bg-primary-foreground dark:bg-card z-30">
      <div
        className={cn(
          "absolute inset-0",
      ...
      <div className="font-inter w-full h-full flex flex-col justify-center items-center text-center z-20">
        ...
        <SlideInFromBottom duration={0.4} delay={0}>
          <h1 className="text-4xl md:text-7xl text-primary w-full font-semibold z-10 mt-4">
            Automate your <br /> culling process
          </h1>
        </SlideInFromBottom>
        <SlideInFromBottom duration={0.5} delay={0.3}>
          <p className="mt-5 md:mt-10 font-inter text-base md:text-2xl max-w-xl text-primary z-10">
            Enhance efficiency, save time, and focus on what truly matters{" "}
...
export default CullingHeroSection;
