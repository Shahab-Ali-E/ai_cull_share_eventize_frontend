    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild disabled={disabled}>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className={`w-full justify-between bg-muted p-5 rounded-sm border border-muted-foreground ${value ?'text-primary' : 'text-muted-foreground'}`}
        >
          {value
