...
interface GridListFaceRecognitionViewProps {
  setToggleView: (value: boolean) => void;
  toggleView: boolean;
}

const GridListFaceRecognitionView: React.FC<GridListFaceRecognitionViewProps> = ({ setToggleView, toggleView }) => {
  return (
...
export default GridListFaceRecognitionView;
