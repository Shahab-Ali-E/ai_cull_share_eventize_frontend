                            ...
                            <FormField
                                ...
                                render={({ field, fieldState: { error } }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Select the city in {selectedCountry.toUpperCase()} where you would like to host your event.
                                        </FormDescription>
                                    </FormItem>
                                )}
                            />
                            <FormField
                                ...
                                render={({ field, fieldState: { error } }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            If you have an alternative city in {selectedCountry.toUpperCase()}, select it here.
                                        </FormDescription>
                                    </FormItem>
                                )}
                            />
